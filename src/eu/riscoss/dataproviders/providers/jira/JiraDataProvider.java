...
public class JiraDataProvider implements AbstractDataProvider {
...
//		public ArrayList<Double> distribution_bugFixTime = new ArrayList<Double>(); //bug fix times in days, divided by ........
	...
	public void createIndicators(IndicatorsMap im, Properties properties) {
		...
		JiraDataProvider.JiraLogStatistics statistics;
		try {
	 ...
	 * @return
	 */
	private JiraDataProvider.JiraLogStatistics retrieveJiraData(Properties properties) throws RuntimeException {
		...
		JiraDataProvider.JiraLogStatistics statistics = null;
		try {
 ...
 */
protected JiraDataProvider.JiraLogStatistics getStatistics(String jiraURL, String jiraProject,
...
//		System.exit(1);
	...
	JiraDataProvider.JiraLogStatistics stats = new JiraDataProvider.JiraLogStatistics();
 ...
 */
private void storeAllMeasures(IndicatorsMap im, JiraDataProvider.JiraLogStatistics statistics) {

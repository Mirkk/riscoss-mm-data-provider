...
//		if (datapoints==null) ...
	...
	/**
	 * Puts datapoints into distribution sets defined by slots. No slot "others", non-matching strings are not considered (for compatibility with the platform)
	 * @param datapoints retrieved data list
	 * @param slots named slots. Key: slot name, Value: array of strings assigned to this slot
	 * @return
	 */
	public static LinkedHashMap<String, Double> getStringDistributionNoOthers(List<String> datapoints, Map<String, String[]> slots) {
...
//				quantityTable.put(noMatch,quantityTable.get(noMatch)+1);
	 ...
	 * @return
	 */
	public static LinkedHashMap<String, Double> getStringDistribution(List<String> datapoints, Map<String, String[]> slots) {
//		Hashtable<String, Integer> quantityTable = new Hashtable<String, Integer>();
